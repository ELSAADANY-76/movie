                ...
                <div class="p-6">
                    <form action="{{ route('movies.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-input id="genre" class="block mt-1 w-full" type="text" name="genre" :value="old('genre')" required />
                        ...
                        <!-- Poster URL -->
                        <div>
                            <x-label for="poster_path" :value="__('Poster Image')" />
                            <x-input id="poster_path" class="block mt-1 w-full" type="file" name="poster_path" required />
                            <x-input-error for="poster_path" class="mt-2" />
                        </div>
